...
public class PlotDiagramView extends JPanel{
	 ...
	 * @param values
	 */
	public PlotDiagramView(List<List<Integer>> values){
		this.values = values;
