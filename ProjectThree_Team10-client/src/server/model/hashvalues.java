...
public class hashvalues {
	...
	static HashMap<String , Double> lowerFace = new HashMap<String,Double>();
	 ...
	 public static void initialize()
	 {
		 ...
		 performanceMatrix.put("engagement", 0.0);
		 performanceMatrix.put("stress", 0.0);
		 performanceMatrix.put("relaxation", 0.0);
		 performanceMatrix.put("focus", 0.0);
		 performanceMatrix.put("excitement", 0.0);
		 performanceMatrix.put("interest", 0.0);
	 }
