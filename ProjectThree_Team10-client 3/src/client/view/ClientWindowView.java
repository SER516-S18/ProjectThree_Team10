...
import client.controller.FacePanel;
import client.controller.FindImage;
...
public class ClientWindowView extends JFrame {
	...
	public void update(Parameters param) {
		...
		LoadImage.load(facePanel, FindImage.findUpperFace(param), FindImage.findLowerFace(param));
		plotPanel.add(param);
